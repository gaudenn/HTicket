...
```json
{
  ...
  "GeminiConfig": {
    "Url": "[https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent](https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent)",
    "ApiKey": "MÃ_API_KEY_GEMINI_CỦA_BẠN"
  }
}
...
GeminiConfig__ApiKey = MÃ_API_KEY_GEMINI_CỦA_BẠN
GeminiConfig__Url = https://generativelanguage.googleapis.com/...
